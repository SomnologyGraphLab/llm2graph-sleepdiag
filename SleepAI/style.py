...
input[type="text"], textarea {
    ...
    font-size: 14px;
    border-radius: 8px;
    border: 1px solid #d0d0d0;  /* 更浅的边框颜色 */
    background-color: #fafafa;  /* 更淡的背景颜色 */
    width: 100%;  /* 占满全宽 */
...
input[type="text"]:focus, textarea:focus {
    ...
    background-color: #ffffff;  /* 聚焦时变为白色背景 */
}
...
input[type="radio"]:checked + label {
    background-color: #A5D4F9;  /* 设置选中的颜色为浅蓝色 */
    border-color: #A5D4F9;      /* 设置边框颜色为浅蓝色 */
}
